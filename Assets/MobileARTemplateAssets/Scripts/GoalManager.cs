...
public class GoalManager : MonoBehaviour
{
    private void Awake()
    {
        ...
        newSteps.Add(m_StepList[0]);
        newSteps.Add(m_StepList[1]);
    ...
    void CompleteGoal()
    {
        if (m_CurrentGoal.CurrentGoal == OnboardingGoals.TapSurface)
            m_ObjectSpawner.objectSpawned.RemoveListener(OnObjectSpawned);
    ...
    void PreprocessGoal()
    {
        ...
        {
            m_SurfacesTapped = 0;
            m_ObjectSpawner.objectSpawned.AddListener(OnObjectSpawned);
        }
    }
